...
//	  public Board create(Board board) {
		...
		if(board.getBattach() != null && !board.getBattach().isEmpty()) {
			...
			try {
//				File file = new File("./a/" + board.getBattachsname());
				File file = new File("/Users/choisukhee/Osstem/temp/uploadfiles/" + board.getBattachsname());
				//
...
//				log.info("f.getAbsolutePath(): " + f.getAbsolutePath());
	...
	public ResponseEntity<InputStreamResource> download(@PathVariable int bno) throws Exception {
		...
		// 파일 입력 스트림 생성
		FileInputStream fis = new FileInputStream("/Users/choisukhee/Osstem/temp/uploadfiles/" + board.getBattachsname());
